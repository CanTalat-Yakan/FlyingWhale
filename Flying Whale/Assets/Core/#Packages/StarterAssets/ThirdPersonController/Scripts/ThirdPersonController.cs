...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private int _animIDMotionX;
        private int _animIDMotionZ;
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDMotionX = Animator.StringToHash("X");
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.sprint && _input.move.magnitude > 0.3f ? SprintSpeed : MoveSpeed;
